    ...
    sections: [
      {
        ...
        body: {
          ...
          nl: "Veel mensen horen een klik in hun kaak en denken meteen aan ernstige schade. De realiteit is geruststellend: **gewrichtsgeluiden zonder pijn zijn in de meeste gevallen onschuldig.** Studies tonen aan dat tot 40% van de bevolking kaakgewrichtsgeluiden heeft — zonder enige behandelbehoefte. Een klik ontstaat vaak door een normale variatie in de discuspositie en is geen teken van slijtage. Tandenknarsen (bruxisme) betekent ook niet automatisch schade: uw kaak is een robuust, aanpasbaar gewricht.",
          tr: "Birçok kişi çenesinde tıklama duyar ve hemen ciddi bir hasar olduğunu düşünür. Gerçek rahatlatıcıdır: **ağrısız eklem sesleri çoğu durumda zararsızdır.** Araştırmalar, nüfusun %40'ına kadarının çene eklemi sesleri olduğunu göstermektedir — herhangi bir tedavi ihtiyacı olmaksızın. Tıklama genellikle disk pozisyonundaki normal bir varyasyondan kaynaklanır.",
          ar: "كثير من الناس يسمعون طقطقة في فكهم ويفكرون فورًا في ضرر خطير. الواقع مطمئن: **أصوات المفصل بدون ألم غير ضارة في معظم الحالات.** تظهر الدراسات أن ما يصل إلى 40٪ من السكان لديهم أصوات في مفصل الفك — دون أي حاجة للعلاج. الطقطقة غالبًا ما تنتج عن تغير طبيعي في وضع القرص وليست علامة على التآكل.",
          pl: "Wiele osób słyszy trzaskanie w żuchwie i natychmiast myśli o poważnym uszkodzeniu. Rzeczywistość jest uspokajająca: **odgłosy stawowe bez bólu są w większości przypadków nieszkodliwe.** Badania pokazują, że do 40% populacji ma odgłosy stawu skroniowo-żuchwowego — bez jakiejkolwiek potrzeby leczenia. Trzaskanie często wynika z normalnej wariacji pozycji krążka i nie jest oznaką zużycia.",
        },
      },
      {
        heading: {
      ...
      },
      {
        ...
        body: {
          de: "Kiefergelenkgeräusche allein sind **kein Grund zur Sorge**. Konsultieren Sie eine spezialisierte Therapeutin, wenn: **Schmerzen beim Kauen** länger als 2 Wochen anhalten, **Mundöffnung eingeschränkt** ist (weniger als 3 Finger breit), **Kopfschmerzen oder Ohrenschmerzen** regelmäßig auftreten und Ihr Arzt keine andere Ursache findet, oder **Kiefer blockiert** und sich nicht mehr normal öffnen lässt. Je früher die Behandlung beginnt, desto schneller reagiert Ihr System. In Eupen bietet Fabienne Dormann kurzfristige Termine für Kiefergelenk-Problematiken an — auch ohne ärztliche Überweisung.",
