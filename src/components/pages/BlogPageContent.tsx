...
const ARTICLES = [
  ...
  },
  {
    ...
    excerpt: {
      de: "Immer mehr unserer Therapeuten sind sowohl als Physiotherapeuten als auch in der Osteopathie ausgebildet. Doch was ist genau der Unterschied zwischen beiden Disziplinen? Florence Joris und Félix Esser erklären, wie die beiden Ansätze sich ergänzen.",
      fr: "De plus en plus de nos thérapeutes sont formés à la fois en kinésithérapie et en ostéopathie. Mais quelle est exactement la différence entre les deux disciplines ? Florence Joris et Félix Esser expliquent comment les deux approches se complètent.",
      en: "More and more of our therapists are trained in both physiotherapy and osteopathy. But what exactly is the difference between the two disciplines? Florence Joris and Félix Esser explain how the two approaches complement each other.",
      nl: "Steeds meer van onze therapeuten zijn opgeleid in zowel fysiotherapie als osteopathie. Maar wat is precies het verschil? Florence Joris en Félix Esser leggen uit hoe de twee benaderingen elkaar aanvullen.",
      tr: "Giderek daha fazla terapistimiz hem fizyoterapi hem de osteopati alanında eğitim almıştır. Peki iki disiplin arasındaki fark tam olarak nedir? Florence Joris ve Félix Esser, iki yaklaşımın nasıl birbirini tamamladığını açıklıyor.",
      ar: "يتلقى عدد متزايد من معالجينا التدريب في كل من العلاج الطبيعي وهشاشة العظام. لكن ما الفرق بالضبط بين التخصصين؟ تشرح فلورانس جوريس وفيليكس إيسر كيف يكمل النهجان بعضهما.",
      pl: "Coraz więcej naszych terapeutów jest przeszkolonych zarówno z fizjoterapii, jak i osteopatii. Ale jaka jest dokładnie różnica między tymi dwiema dyscyplinami? Florence Joris i Félix Esser wyjaśniają, jak oba podejścia się uzupełniają.",
    },
