...
const THERAPISTS = [
  {
    ...
    accentColor: "#2b3186",
    role: {
      de: "Manualtherapeut — Praxisleiter",
      fr: "Thérapeute Manuel — Directeur",
      en: "Manual Therapist — Director",
      nl: "Manueel Therapeut — Directeur",
      tr: "Manuel Terapist — Direktör",
      ar: "معالج يدوي — مدير",
      pl: "Terapeuta Manualny — Dyrektor",
    },
